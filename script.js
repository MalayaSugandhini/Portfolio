document.addEventListener("DOMContentLoaded", function () {
    console.log("DOM fully loaded, executing hero section JS");
    ...
    if (typeof Typed !== "undefined") {
      ...
      console.error("Typed is not defined. Make sure Typed.js is loaded.");
    }
  
    // Naruto Image Toggle Functionality
    const avatarImg = document.getElementById("hero-avatar");
    const narutoMessage = document.getElementById("naruto-message");
    console.log("Avatar element:", avatarImg, "Naruto message element:", narutoMessage);
    let isNaruto = false;
    if (avatarImg && narutoMessage) {
      avatarImg.addEventListener("click", function () {
        console.log("Avatar clicked");
        if (isNaruto) {
          avatarImg.src = "assets/avatar.png";
          narutoMessage.classList.add("hidden");
        } else {
          avatarImg.src = "assets/Naruto.png";
          narutoMessage.classList.remove("hidden");
        }
        isNaruto = !isNaruto;
      });
    } else {
      console.error("Avatar image or Naruto message element not found");
    }
